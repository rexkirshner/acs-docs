...
1. **[/update-context](/commands/update-context)** — Extracts permanent learnings from the conversation and updates CLAUDE.md and AGENTS.md
2. **[/save-session](/commands/save-session)** — Records session history when you want it (not automatically)
3. **[/review](/commands/review)** — Comprehensive code review
4. **[/cleanup-acs](/commands/cleanup-acs)** — Removes all ACS artifacts from any project
...
*The cleanup command that removed it all: [/cleanup-acs](/commands/cleanup-acs) — still available if you need to undo your own over-engineering*
